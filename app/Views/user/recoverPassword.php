...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo site_url();?>AdminLTE/index2.html"><b>Admin</b>LTE</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <?php echo form_open($this->data['action'],['id'=>'forgetpwd'],['_token'=>session()->getTempdata('fogetpwd')]); ?>
        <div class="input-group mb-3">
          ...
          <span class="verror"><?php if (isset($verror['password'])) {
                                  echo $verror['password'];
                                } ?></span>
        </div>
        <div class="input-group mb-3">
          <input type="password" name="password_again" value="" class="form-control" placeholder="Confirm Password">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
          </div>
          <span class="verror"><?php if (isset($verror['password_again'])) {
                                  echo $verror['password_again'];
                                } ?></span>
        </div>
        <div class="row">
          <div class="col-12">
